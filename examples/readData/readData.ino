...
0x06,0x00,0x06,0xFE,0xFF,0x07,0xFE,0xFF,0x07,0x00,0x00,0x00}; //紫外线强度
...
0x38,0x86,0x01,0x10,0xFE,0x01,0xFE,0xFE,0x01,0x00,0x00,0x00}; //海拔高度
...
0x00,0x04,0x00,0x00,0x04,0x00,0x00,0x00,0x00,0x00,0x00,0x00}; //光照
...
//     u8g2.drawXBMP( /* x=*/64 , /* y=*/1 , /* width=*/20 , /* height=*/20 , col1 );
     u8g2.drawXBMP( /* x=*/0 , /* y=*/30 , /* width=*/20 , /* height=*/20 , col1 );
//     u8g2.drawXBMP( /* x=*/64 , /* y=*/30 , /* width=*/20 , /* height=*/20 , col3 );
